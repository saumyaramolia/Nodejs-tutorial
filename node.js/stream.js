...
/* About:
    ...
    stream.pipe() - converts readable to writeable.
*/  

const {createReadStream} = require('fs');

const stream = createReadStream('./modules/Built-in-modules/content/big-text.txt', {highWaterMark: 90000, encoding: 'utf8'}) // [1]
